...
## [2026-09-09] ingest | Фикс verify при стаб-коде; SMS-конфиг в config/sms.php
- Источники: фикс verify (latest по id при коллизии hash — стаб-код), перенос кулдауна SMS в config/sms.php
- Updated: Публичный сайт (SMS: контракт, стаб-код, кулдаун — config/sms.php)
